      ...
      <div class="container">
		   ...
		   <div class="py-4 text-center">
			...
			<table class="table table-hover table-sm">
			     ...
			     List<Pedido> listaPedidos =  pedidoDAO.listarPedidosEC(); //conectarse a la DB y traer un listado con todos los pedidos
			     ...
			     for(int i=0;  i<listaPedidos.size();  i++) {
			    	 	...
			    	 	out.println("<td>" + listaPedidos.get(i).getLocalidad() + "</td>");
